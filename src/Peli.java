...
/**
 *
 * Tämän luokan tarkoituksena on luoda itse graafinen peli, jossa on sekä 1 tai
 * 2 pelaajaa, kortit tulevat png-kuvina. Hiirtä klikkamalla valitaan kortti.
 * Kortit ovat JButtoneita.
 *
 * @author tanelvir
 */
import java.awt.*;
...
public class Peli extends javax.swing.JFrame {
    ...
    public void settaaArvot(int pelaajamaara, String nimi1, String nimi2) {
        ...
        if (pelaajamaara == 1) {
            ...
            mod = Pelimoodi.YKSINPELI;
        } else if (pelaajamaara == 2) {
            mod = Pelimoodi.KAKSINPELI;
        }
        avattujaKortteja = 0;
...
//      nappulat = {jButton1,jButton2,jButton3,jButton4,jButton5,jButton6,jButton7,jButton8,jButton9,jButton10,jButton11,jButton12,jButton12,jButton13,jButton14,jButton15,jButton16 };
    ...
    /**
     * Katsotaan, onko kortti avattu vai ei, jos on se käännetään takaisin, jos
     * ei niin kuva näytetään.
     *
...
//            nabula.setEnabled(false);
        ...
        this.jLabel3.setText("" + peli.getPelaaja1().getNimi() + " pisteet: " + peli.getPelaaja1().getPisteet());
        ...
        if (mod.equals(Pelimoodi.KAKSINPELI)) {
            ...
            jLabel4.setText("" + peli.getPelaaja2().getNimi() + " pisteet: " + peli.getPelaaja2().getPisteet());
    ...
    /**
     * Tässä luodaan itse Nappulataulukko, jotta jokaiselle nappulalle ei
     * tavitse erikseen säätää kuvia.
     *
     * @param game
    ...
    private void nollaaAvatut() {
        ...
        for (int i = 0; i < nappulat.length; i++) {
            System.out.print("" + (i+1) + ": " + peli.getKP().getKortti(i + 1));
            if (i<15) {
                System.out.print(", ");
            }
            vaihdaTeksti(i);
